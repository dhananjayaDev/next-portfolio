...
return (
  <div
    ...
    style={{
      ...
      backgroundColor: 'linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(69,69,84,1) 26%, rgba(12,14,35,1) 100%)',
    }}
  >
      <div className={`${id === 6  && 'flex justify-center'} h-full`}>
          ...
          <div className={cn(
              ...
              <div className="font-sans font-extralight text-[#c1c2d3] text-sm ms:text-xs lg:text-base z-10">
                  {description}
              </div>
